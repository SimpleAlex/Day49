...
var MID_HEIGHT = canvas.height/2;
                        //  x,   y,         color  , size
var walkers = [new Walker(200, MID_HEIGHT, '#34a5ac', 1.5),
               new Walker(300, MID_HEIGHT, '#c73939', 1.5),
               new Walker(400, MID_HEIGHT, '#4532a6', 1.5),
               new Walker(500, MID_HEIGHT, '#4dc968', 1.5),
               new Walker(600, MID_HEIGHT, '#EF9D42', 1.5),
               new Walker(700, MID_HEIGHT, '#cf932d', 1.5),
               new Walker(800, MID_HEIGHT, '#42a6ee', 1.5)];
